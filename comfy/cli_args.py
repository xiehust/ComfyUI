...
parser.add_argument("--neuron", action="store_true", help="Force AWS Neuron (Inferentia/Trainium) backend. Requires torch_xla + torch_neuronx and a /dev/neuron* device.")
